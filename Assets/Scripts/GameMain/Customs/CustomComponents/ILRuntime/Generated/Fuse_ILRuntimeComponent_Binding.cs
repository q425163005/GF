...
{
    unsafe class Fuse_ILRuntimeComponent_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(Fuse.ILRuntimeComponent);
            args = new Type[]{};
        ...
        static StackObject* GetHotfixTypes_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            Fuse.ILRuntimeComponent instance_of_this_method = (Fuse.ILRuntimeComponent)typeof(Fuse.ILRuntimeComponent).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
