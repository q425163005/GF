...
namespace ILRuntime.Runtime.Generated
{
    unsafe class UnityEngine_Animator_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            app.RegisterCLRMethodRedirection(method, SetInteger_0);
            ...
            app.RegisterCLRMethodRedirection(method, SetBool_2);
        ...
        static StackObject* SetInteger_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
