...
{
    unsafe class Fuse_Tasks_RoutineBase_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(Fuse.Tasks.RoutineBase);
            args = new Type[]{};
            ...
            app.RegisterCLRMethodRedirection(method, WaitUntil_1);
        ...
        static StackObject* get_IsCompleted_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            Fuse.Tasks.RoutineBase instance_of_this_method = (Fuse.Tasks.RoutineBase)typeof(Fuse.Tasks.RoutineBase).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
        ...
        static StackObject* WaitUntil_1(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
            StackObject* __ret = ILIntepreter.Minus(__esp, 1);
            ...
            var result_of_this_method = Fuse.Tasks.RoutineBase.WaitUntil(@condition);
