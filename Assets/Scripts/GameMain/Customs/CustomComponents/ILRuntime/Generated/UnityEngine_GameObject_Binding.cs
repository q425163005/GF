...
namespace ILRuntime.Runtime.Generated
{
    unsafe class UnityEngine_GameObject_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            args = new Type[]{typeof(Fuse.HotfixEntityLogic)};
            if (genericMethods.TryGetValue("GetComponent", out lst))
            {
                foreach(var m in lst)
                {
                    if(m.MatchGenericParameters(args, typeof(Fuse.HotfixEntityLogic)))
                    {
                        method = m.MakeGenericMethod(args);
            ...
            args = new Type[]{typeof(Fuse.HotfixUGuiForm)};
            if (genericMethods.TryGetValue("GetComponent", out lst))
            {
                foreach(var m in lst)
                {
                    if(m.MatchGenericParameters(args, typeof(Fuse.HotfixUGuiForm)))
                    {
                        method = m.MakeGenericMethod(args);
        ...
        static StackObject* GetComponent_4(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            var result_of_this_method = instance_of_this_method.GetComponent<Fuse.HotfixEntityLogic>();
        ...
        static StackObject* GetComponent_17(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            var result_of_this_method = instance_of_this_method.GetComponent<Fuse.HotfixUGuiForm>();
