...
{
    unsafe class Fuse_UpdateResourceForm_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(Fuse.UpdateResourceForm);
        ...
        static StackObject* SetProgress_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            Fuse.UpdateResourceForm.SetProgress(@progress, @description);
