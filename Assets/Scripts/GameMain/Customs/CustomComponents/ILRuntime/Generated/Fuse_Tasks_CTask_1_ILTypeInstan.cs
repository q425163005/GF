...
{
    unsafe class Fuse_Tasks_CTask_1_ILTypeInstance_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(Fuse.Tasks.CTask<ILRuntime.Runtime.Intepreter.ILTypeInstance>);
            args = new Type[]{};
        ...
        static StackObject* Create_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            var result_of_this_method = Fuse.Tasks.CTask<ILRuntime.Runtime.Intepreter.ILTypeInstance>.Create();
        ...
        static StackObject* Start_1(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            Fuse.Tasks.CTask<ILRuntime.Runtime.Intepreter.ILTypeInstance> instance_of_this_method = (Fuse.Tasks.CTask<ILRuntime.Runtime.Intepreter.ILTypeInstance>)typeof(Fuse.Tasks.CTask<ILRuntime.Runtime.Intepreter.ILTypeInstance>).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
