...
namespace ILRuntime.Runtime.Generated
{
    unsafe class System_Linq_Enumerable_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            args = new Type[]{typeof(System.Action<Google.Protobuf.IMessageAdaptor.Adaptor>)};
            if (genericMethods.TryGetValue("ToArray", out lst))
            {
                foreach(var m in lst)
                {
                    if(m.MatchGenericParameters(args, typeof(System.Action<Google.Protobuf.IMessageAdaptor.Adaptor>[]), typeof(System.Collections.Generic.IEnumerable<System.Action<Google.Protobuf.IMessageAdaptor.Adaptor>>)))
                    {
                        method = m.MakeGenericMethod(args);
        ...
        static StackObject* ToArray_1(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            ptr_of_this_method = ILIntepreter.Minus(__esp, 1);
            System.Collections.Generic.IEnumerable<System.Action<Google.Protobuf.IMessageAdaptor.Adaptor>> @source = (System.Collections.Generic.IEnumerable<System.Action<Google.Protobuf.IMessageAdaptor.Adaptor>>)typeof(System.Collections.Generic.IEnumerable<System.Action<Google.Protobuf.IMessageAdaptor.Adaptor>>).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
            __intp.Free(ptr_of_this_method);


            var result_of_this_method = System.Linq.Enumerable.ToArray<System.Action<Google.Protobuf.IMessageAdaptor.Adaptor>>(@source);
