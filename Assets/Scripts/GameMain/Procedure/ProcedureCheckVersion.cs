    ...
    public class ProcedureCheckVersion : ProcedureBase
    {
        ...
        protected override void OnEnter(ProcedureOwner procedureOwner)
        {
            ...
            GameEntry.WebRequest.AddWebRequest(
                                               Utility.Text.Format(GameEntry.BuiltinData.BuildInfo.CheckVersionUrl,
                                                                   GetPlatformPath()), this);
        }
        ...
        private void OnWebRequestSuccess(object sender, GameEventArgs e)
        {
            ...
            if (m_VersionInfo.ForceUpdateGame)
            {
                ...
                UpdateResourceForm m_UpdateResourceForm =
                    (UpdateResourceForm) GameEntry.UI.GetUIForm(AssetUtility.UpdateFormAsset).Logic;
            ...
            switch (Application.platform)
            {
                ...
                default:
                    throw new System.NotSupportedException(
                                                           Utility.Text.Format("Platform '{0}' is not supported.",
