    ...
    public sealed class Fsm : FsmBase, IFsm
    {
            ...
            : base(name)
        {
            ...
            foreach (FsmState state in states)
            {
                ...
                {
                    throw new GameFrameworkException(Utility.Text.Format("FSM '{0}' state '{1}' is already exist.", Utility.Text.Format(OwnerType.FullName,name), stateName));
                }
        ...
        public void Start<TState>() where TState : FsmState
        {
            ...
            if (state == null)
            {
                throw new GameFrameworkException(Utility.Text.Format("FSM '{0}' can not start state '{1}' which is not exist.", Utility.Text.Format(OwnerType.FullName, Name), typeof(TState).FullName));
            }
        ...
        public void Start(Type stateType)
        {
            ...
            if (state == null)
            {
                throw new GameFrameworkException(Utility.Text.Format("FSM '{0}' can not start state '{1}' which is not exist.", Utility.Text.Format(OwnerType.FullName, Name), stateType.FullName));
            }
        ...
        internal void ChangeState(Type stateType)
        {
            ...
            if (state == null)
            {
                throw new GameFrameworkException(Utility.Text.Format("FSM '{0}' can not change state to '{1}' which is not exist.", Utility.Text.Format(OwnerType.FullName, Name), stateType.FullName));
            }
